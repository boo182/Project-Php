...
<input type="text" name="name" min="2" max="25" value=""> 
</p>
...
if(isset($_POST['send']))
{
	$exist_mail = if_exist($_POST['email']); //Verification de l'existence de l'user dans la db 
...
<input type="password" name="password"  min="3" max="25" value="">
<div>
<label for="confirm_password">Confirm password:</label>
</div>
<input type="password" name="confirm_password"  min="3" max="25" value="">
</p>
...
if(isset($_POST['send']) && $flag == 0 ) // verif du flag d'erreur et de l'envoi du form
{
	...
	echo $_POST['name']." was successfully created";
}
